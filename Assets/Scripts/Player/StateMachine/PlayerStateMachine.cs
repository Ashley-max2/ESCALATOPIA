...
public class PlayerStateMachine : MonoBehaviour
{
    ...
    public void MoveRelativeToCamera(Vector3 inputDirection, float speed, float controlMultiplier = 1f)
    {
        ...
        if (AnalyticsManager.Instance != null && inputDirection.sqrMagnitude > 0.001f)
        {
            AnalyticsManager.Instance.RecordMovement(new Vector2(inputDirection.x, inputDirection.z));
        }
